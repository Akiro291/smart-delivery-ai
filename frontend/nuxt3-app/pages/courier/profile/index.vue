<template>
  <div class="space-y-6 max-w-lg">
    <div>
      ...
      <p class="text-gray-500 text-sm mt-1">Данные курьера</p>
    </div>

    <div class="card overflow-hidden">
      <div class="bg-gradient-to-r from-emerald-600 to-emerald-800 px-6 py-8 text-white flex items-center gap-4">
