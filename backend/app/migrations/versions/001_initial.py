...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum("CUSTOMER", "COURIER", "MANAGER", "ADMIN", name="userrole", create_type=True),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "type",
            sa.Enum("EMAIL", "TELEGRAM", "PUSH", "SMS", name="notificationtype", create_type=True),
            nullable=False,
        ),
        sa.Column(
            "status",
            sa.Enum("PENDING", "SENT", "FAILED", "READ", name="notificationstatus", create_type=True),
            nullable=False,
        ),
